...
import { IoIosArrowForward, IoMdMenu, IoMdCog, IoMdPower, IoMdRefresh } from "react-icons/io";
...
function App() {
  ...
  return (
    <GlobalKeyboardProvider darkMode={darkMode}>
      <div className={`font-sans relative overflow-hidden ${darkMode ? 'bg-gray-900' : 'bg-white'}`} style={{ width: '100vw', height: '100vh' }}>
        {/* Sidebar Overlay */}
        {isNavOpen && (
          <div
        ...
        <div className={`flex items-center px-4 py-3 border-b-2 fixed top-0 left-0 right-0 z-50 ${
          darkMode 
          ...
          <h1 className={`ml-3 text-base font-semibold m-0 ${
        ...
        >
          <div className={`flex items-center justify-between p-4 border-b-2 ${
            ...
            <span className={`text-xl font-bold ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>Menu</span>
            <button
