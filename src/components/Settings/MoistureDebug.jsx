      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">Seven-Segment Display Detector</h1>
          </div>
          <p className="text-slate-400">Test and visualize segment detection with binary states (0/1)</p>
          {calibrationInfo?.hasDecimalPoint && (
            ...
            <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
              ...
              {!uploadedImage ? (
                ...
                >
                  ...
                  <p className="text-sm text-slate-400">Upload moisture meter display image</p>
                </div>
              ) : (
                <div>
                  <img 
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-slate-400">Green box with "1"</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-slate-400">Red box with "0"</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-br from-green-900/40 to-emerald-900/40 rounded-lg p-6 text-center border border-green-700">
                    <div className="text-sm text-slate-400 mb-2">Detected Reading</div>
                  ...
                  {/* Per-Digit Analysis */}
                  {recognitionResult.digits && recognitionResult.digits.length > 0 && (
                    <div>
                      <h4 className="text-sm font-medium text-slate-400 mb-3">Per-Digit Breakdown</h4>
                      <div className="grid grid-cols-3 gap-3">
                        {recognitionResult.digits.map((digit, idx) => (
                          <div key={idx} className="bg-slate-900 rounded-lg p-4 text-center border border-slate-700">
                            <div className="text-xs text-slate-400 mb-2">Digit {idx + 1}</div>
                            <div className={`text-4xl font-bold mb-2 ${
                              digit.recognized_digit === '?' ? 'text-red-400' : 'text-green-400'
                            }`}>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-slate-900 rounded-lg p-3 border border-slate-700">
                      ...
                      <div className="text-sm font-medium">Simple Threshold</div>
                    </div>
                    <div className="bg-slate-900 rounded-lg p-3 border border-slate-700">
                      <div className="text-xs text-slate-400 mb-1">Valid</div>
                      <div className={`text-sm font-medium ${
                        recognitionResult.is_valid ? 'text-green-400' : 'text-red-400'
                      }`}>
            ...
            {!visualizationImage && !recognitionResult && !error && (
              <div className="bg-slate-800 rounded-xl p-8 border border-slate-700 text-center">
                ...
                <p className="text-slate-400">
                  Upload an image and click <strong>Visualize</strong> to see segment detection,
                  or <strong>Recognize</strong> to read the number.
                </p>
              </div>
            )}
