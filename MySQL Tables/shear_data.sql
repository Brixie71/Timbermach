...
--
-- Table structure for table `shear_data`
--

CREATE TABLE `shear_data` (
  `shear_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Indexes for table `shear_data`
--
ALTER TABLE `shear_data`
  ADD PRIMARY KEY (`shear_id`),
  ADD KEY `shear_data_species_id_index` (`species_id`);
...
--
-- AUTO_INCREMENT for table `shear_data`
--
ALTER TABLE `shear_data`
  MODIFY `shear_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
